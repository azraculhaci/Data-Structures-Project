...
struct node
{
	...
	node::node(const string &s, node * linkRight, node * linkLeft)
		: data(s), right(linkRight), left(linkLeft)
	{}
};
...
public:
	...
	void deleteList(); //deletes all of the dynamicaly allocated nodes
};
