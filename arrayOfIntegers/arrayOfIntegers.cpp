...
int main()
{
	...
	cout << "The sum of the elements in the array (through the array of integers): " << sumArray << endl;
	...
	cout << "The sum of the elements in the array (through the array of integer pointers): " << sumPointer << endl;
